const getMobileFriendlyData = async (url) => {
  ...
  const fullUrl = `${apiUrl}?${categoryParams}&strategy=${strategy}&url=${encodedUrl}&key=${apiKey}`;
...
export default getMobileFriendlyData;

// Define the functions to handle quick and slow responses outside of getMobileFriendlyData
